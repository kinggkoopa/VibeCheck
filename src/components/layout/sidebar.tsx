...
const NAV_ITEMS = [
  ...
  { href: "/dashboard/profit", label: "Profit Agent" },
  { href: "/dashboard/math-guardian", label: "Math Guardian" },
  { href: "/dashboard/alpha-sim", label: "Alpha Simulator" },
  { href: "/dashboard/comprehension", label: "Comprehension Gate" },
  { href: "/dashboard/kalshi", label: "Kalshi Alpha" },
  { href: "/dashboard/polymarket", label: "Polymarket Max" },
  { href: "/dashboard/vibe-wizard", label: "Vibe Wizard" },
  { href: "/dashboard/results-booster", label: "Results Booster" },
  { href: "/dashboard/opus-handoff", label: "Opus Handoff" },
  { href: "/dashboard/godot", label: "Godot Viber" },
  { href: "/dashboard/unreal", label: "Unreal Pro" },
  { href: "/dashboard/game-engine", label: "Game Engine" },
  { href: "/dashboard/gaming", label: "Game Creator" },
  { href: "/dashboard/music-edu", label: "Music Edu" },
